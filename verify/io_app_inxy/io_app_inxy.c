...
{
	APP_INXY_MODULE_TYPE,
	APP_INXY_MODULE_NR_DEF,
	...
	{LCSA_CONFIG_DLC_USED_4, LCSA_CONFIG_DLC_USED_0, LCSA_CONFIG_DLC_USED_0, LCSA_CONFIG_DLC_USED_0},
	{NULL, NULL, NULL, NULL},
	{NULL, NULL, NULL, NULL},
	{NULL, NULL, NULL, NULL},
...
/*--------------------------------------------------------------------------*/
/**
 * @brief initialization of the INXY module
 * @param modnr used module number
 * @return lcsa_errorcode_t or LCSA_ERROR_OK if successful
 */
lcsa_errorcode_t app_inxy_init(li_can_slv_module_nr_t modnr)
{
	...
	/*----------------------------------------------------------------------*/
	err = lcsa_add_module(&app_inxy_can_module, modnr,
	                      NULL, NULL, NULL, NULL,
	                      &app_inxy_can_tx_data, NULL, NULL, NULL);
	...
	if (err == LCSA_ERROR_OK)
	{
		err = lcsa_is_module_valid(APP_INXY_MODULE_TYPE, modnr, &app_inxy_can_config_table_pos);
	}
...
{
	app_inxy_can_tx_data[1] = incy;
}

/**
 * @brief process output function for the INXY module
 * @return #lcsa_errorcode_t or LCSA_ERROR_OK if successful
 */
