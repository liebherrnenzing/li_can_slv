...
#ifndef LI_CAN_SLV_RECONNECT_BAUDRATE_SWITCH_TIME_STARTUP
#define LI_CAN_SLV_RECONNECT_BAUDRATE_SWITCH_TIME_STARTUP	((uint16_t)(60)) /**< baudrate switch time during startup reconnect in msec */
#endif // #ifndef LI_CAN_SLV_RECONNECT_BAUDRATE_SWITCH_TIME_STARTUP

#ifndef LI_CAN_SLV_RECONNECT_BAUDRATE_SWITCH_TIME_ONLINE
#define LI_CAN_SLV_RECONNECT_BAUDRATE_SWITCH_TIME_ONLINE	((uint16_t)(2)) /**< baudrate switch time during online reconnect in msec */
#endif // #ifndef LI_CAN_SLV_RECONNECT_BAUDRATE_SWITCH_TIME_ONLINE
