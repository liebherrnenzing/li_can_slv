...
#define CAN_CONFIG_MSG_MAIN_OBJ_ASYNC_CTRL1_RX	(0u) /*!< used CAN message object for receiving asynchronous control data (logical module 1) */
#define CAN_CONFIG_MSG_MAIN_OBJ_ASYNC_CTRL2_RX	(1u) /*!< used CAN message object for receiving asynchronous control data (logical module 2) */
#define CAN_CONFIG_MSG_MAIN_OBJ_ASYNC_CTRL3_RX	(2u) /*!< used CAN message object for receiving asynchronous control data (logical module 3) */
#define CAN_CONFIG_MSG_MAIN_OBJ_ASYNC_CTRL4_RX	(3u) /*!< used CAN message object for receiving asynchronous control data (logical module 4) */
#define CAN_CONFIG_MSG_MAIN_OBJ_ASYNC_CTRL5_RX	(4u) /*!< used CAN message object for receiving asynchronous control data (logical module 5) */
#define CAN_CONFIG_MSG_MAIN_OBJ_ASYNC_CTRL6_RX	(5u) /*!< used CAN message object for receiving asynchronous control data (logical module 6) */
#define CAN_CONFIG_MSG_MAIN_OBJ_ASYNC_CTRL7_RX	(6u) /*!< used CAN message object for receiving asynchronous control data (logical module 7) */
#define CAN_CONFIG_MSG_MAIN_OBJ_ASYNC_CTRL8_RX	(7u) /*!< used CAN message object for receiving asynchronous control data (logical module 8) */
#endif // #ifdef LI_CAN_SLV_ASYNC

#ifndef LI_CAN_SLV_MAX_NR_OF_LOGICAL_MODULES
#define LI_CAN_SLV_MAX_NR_OF_LOGICAL_MODULES	(1u)
...
#define CAN_CONFIG_SYNC_MON_MAX_NR_OF_TX_OBJ	(16u) /**< */

#define CAN_CONFIG_ACCEPTANCE_ONE_ID	(0x07FFu) /*!< acceptance mask is set to 1 identifier */
#define CAN_CONFIG_ACCEPTANCE_MASK		(0x0603u) /**< */

/* CAN Liebherr protocol definitions */

/* process request */
#define CAN_CONFIG_PROCESS_ID	(0x0001u) /*!< CAN identifier of process request */
#define CAN_CONFIG_PROCESS_DLC	LI_CAN_SLV_CONFIG_DLC_USED_1 /*!< DLC of process request */

#define CAN_CONFIG_ID_NULL	(0x0000u) /*!< CAN identifier null */

/* system messages */
#define CAN_CONFIG_SYS_MSG_ID	(0x0002u) /*!< CAN identifier of system message */
#define CAN_CONFIG_SYS_MSG_DLC	LI_CAN_SLV_CONFIG_DLC_USED_8 /*!< DLC of system message */
#define CAN_CONFIG_SYS_TX_MASK	(0x0003u) /*!< transmit system message mask */

#ifdef LI_CAN_SLV_ASYNC
/* asynchron control data */
#define CAN_CONFIG_ASYNC_CTRL_TX_SLAVE_ID	(0x0601u) /*!< CAN identifier of asynchronous control data tx slave */
#define CAN_CONFIG_ASYNC_CTRL_TX_MASTER_ID	(0x0600u) /*!< CAN identifier of asynchronous control data tx master */
#define CAN_CONFIG_ASYNC_CTRL_TX_DLC		LI_CAN_SLV_CONFIG_DLC_USED_8	/*!< DLC of asynchronous control data tx */

/* asynchron data */
#define CAN_CONFIG_ASYNC_DATA_TX_SLAVE_ID	(0x0603u) /*!< CAN identifier of asynchronous data tx slave */
#define CAN_CONFIG_ASYNC_DATA_TX_MASTER_ID	(0x0602u) /*!< CAN identifier of asynchronous data tx master */
...
#define CAN_CONFIG_TYPE_STRING_LENGTH	(5u) /*!< type string length inclusive 0-character*/

#define LI_CAN_SLV_CONFIG_OBJ_USED_NOT	(0u) /**< */
#define LI_CAN_SLV_CONFIG_OBJ_USED_1	(1u) /**< */
#define LI_CAN_SLV_CONFIG_OBJ_USED_2	(2u) /**< */
#define LI_CAN_SLV_CONFIG_OBJ_USED_3	(3u) /**< */
#define LI_CAN_SLV_CONFIG_OBJ_USED_4	(4u) /**< */

#define LI_CAN_SLV_CONFIG_DLC_USED_0		(0u) /**< */
#define LI_CAN_SLV_CONFIG_DLC_USED_1		(1u) /**< */
#define LI_CAN_SLV_CONFIG_DLC_USED_2		(2u) /**< */
#define LI_CAN_SLV_CONFIG_DLC_USED_3		(3u) /**< */
#define LI_CAN_SLV_CONFIG_DLC_USED_4		(4u) /**< */
#define LI_CAN_SLV_CONFIG_DLC_USED_5		(5u) /**< */
#define LI_CAN_SLV_CONFIG_DLC_USED_6		(6u) /**< */
#define LI_CAN_SLV_CONFIG_DLC_USED_7		(7u) /**< */
#define LI_CAN_SLV_CONFIG_DLC_USED_8		(8u) /**< */
