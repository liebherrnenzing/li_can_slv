# -*- coding: utf-8 -*-
#
# li_can_slv documentation build configuration file, created by
# sphinx-quickstart on Mon Apr 11 12:30:37 2016.
#
...
if on_rtd:
    ...
    shutil.rmtree(str(Path('_doxyhtml')), ignore_errors=True)
...
breathe_projects = {"li_can_slv": '_doxyxml/'}
...
htmlhelp_basename = 'li_can_slvdoc'
