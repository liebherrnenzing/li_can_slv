...
typedef enum
{
	...
	LCSA_MODULE_CHANGE_VALID_BUT_SET_SILENT ///< change will be proceeded the identfiers changed but the module will not respond to any message until an reboot or an AWAKE command
