...
set ASTYLE_CODESTYLE_PARAMS=--mode=c --style=allman --indent=tab=4 --indent-switches --indent-col1-comments --pad-oper --pad-header --unpad-paren --lineend=windows --add-brackets --align-pointer=name
